...
@router.get("/save_show/{show_name}")
...
@router.get("/list_shows")
def list_shows():
    return {"shows": Show.list_shows()}

@router.get("/new_show/{show_name}")
...
@router.get("/copy_cue/{old_cue}/{new_cue}")
...
@router.get("/move_cue/{old_location}/{new_location}")
...
@router.get("/move_cue_up/{location}/{amount}")
...
@router.get("/move_cue_down/{location}/{amount}")
async def move_cue(location: int, amount: int):
    global show
    if show:
...
@router.get("/move_command/{cue}/{old_location}/{new_location}")
...
@router.post("/update_command/{cue}/{command}")
